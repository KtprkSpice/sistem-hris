...
<head>
    ...
    <!-- Dripicon -->
    <link rel="stylesheet" href="{{ asset('dist/assets/compiled/css/ui-icons-dripicons.css') }}">
    <link rel="stylesheet" href="{{ asset('dist/assets/extensions/@icon/dripicons/dripicons.css') }}">
</head>
...
<body>
                    ...
                    <ul class="menu">
                        ...
                        @if (session('jabatan') == 'HR')
                            ...
                            <li class="sidebar-item  {{ request()->is('tugas') ? 'active' : '' }}">
                                <a href={{ route('tugas.index') }} class='sidebar-link'>
                            ...
                            <li class="sidebar-item  {{ request()->is('departemen') ? 'active' : '' }}">
                                <a href={{ route('departemen.index') }} class='sidebar-link'>
                        ...
                        @if (in_array(session('jabatan'), ['Developer', 'Sales', 'Finance']))
                            <li class="sidebar-item {{ request()->is('dashboard') ? 'active' : '' }} ">
                                <a href={{ route('dashboard') }} class='sidebar-link'>
                                    <i class="bi bi-grid-fill"></i>
                                    <span>Dashboard</span>
    ...
    <script>
        ...
        var ctxBar = document.getElementById("presences").getContext("2d");
        ...
        function updateData() {
            fetch("/dashboard/presences")
                .then(response => response.json()) // panggil fungsi json()
                .then((output) => {
                    mybar.data.datasets[0].data = output; // update data
                    mybar.update();
                })
